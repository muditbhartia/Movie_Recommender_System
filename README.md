...
An example would be like ![this](http://www.github.com/muditbhartia/movie_recommender_system/Images/img3.png)
### Downloads and Contribution 
To clone the repo 
```
$ git clone https://github.com/muditbhartia/Movie-Recommendation
```
